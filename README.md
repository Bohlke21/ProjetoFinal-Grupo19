...
Para realizar um teste e execução do programa você pode abrir a pasta no VSCode (Visual Studio Code) e então acessar a classe App e "rodá-la". Ao fazer isso, a tela do sistema abrirá e você poderá interagir com as funcionalidades.
